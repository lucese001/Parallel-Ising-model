...
LOGFILE="output/tc_2D_64_hot_s${SEED}_${PBS_JOBID}.log"
exec > "$LOGFILE" 2>&1
...
echo "Scan vicino a Tc 2D — 64x64 — HOT START"
echo "Tc_2D ~ 2.269  |  passo 0.005  |  9 temperature"
echo "SEED=$SEED"
echo "Start: $(date)"
echo ""
...
NCONFS=(  1200000 1200000 1200000 1200000 1200000 1200000 1200000 1200000 1200000  )
...
echo "Scan Tc 64x64 hot completato"
echo "Fine: $(date)"
